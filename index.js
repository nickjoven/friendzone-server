...
// I want to type localhost:3005/friends and get a list of the friends in the array above
app.get('/friends', (req, res) => {
    res.json(FRIENDS)
})

// I want to type localhost:3005/friend_requests and see the pending requests
